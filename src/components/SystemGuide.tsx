    ...
    <div className="max-w-5xl mx-auto space-y-12 animate-in fade-in duration-500 pb-20">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <GuideCard 
          ...
          title="3. Next Steps"
          description="การติดตั้ง QR Code บนตัวเครื่อง, ระบบแจ้งเตือนผ่าน Line Notify แบบเรียลไทม์ และระบบซิงค์ข้อมูลผ่าน Cloud"
        />
      </div>
         ...
         <section className="space-y-6 border-t border-gray-50 pt-10">
            ...
            <ul className="space-y-4">
               ...
               <li className="flex items-start space-x-3">
                  ...
                  <p className="text-gray-600"><strong>Line Notify Integration:</strong> เชื่อมต่อ API เพื่อส่งข้อความแจ้งเตือนหาหัวหน้างานเมื่อพนักงานลืมทำหน้าที่</p>
               </li>
               <li className="flex items-start space-x-3">
