  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-black text-gray-800 tracking-tight">{t.formGroups}</h1>
          <p className="text-lg text-gray-500 font-medium">{t.groupDesc}</p>
        </div>
        <button 
          onClick={handleSave}
        ...
        <div className="lg:col-span-1 space-y-6">
           <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden sticky top-6">
              <div className="p-6 border-b border-gray-50 bg-gray-50/50 space-y-4">
                 <div className="flex items-center justify-between">
                   <h3 className="text-base font-black text-gray-400 uppercase tracking-widest">{t.presetGroups} ({filteredBundles.length})</h3>
                 ...
                 <select
                   ...
                   className="w-full text-base p-4 rounded-lg border border-gray-200 bg-white text-gray-700 outline-none focus:border-[#00468B] transition-colors"
                 >
        ...
        <div className="lg:col-span-3 space-y-6">
          <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 space-y-8">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                   <label className="block text-base font-bold text-[#00468B] uppercase mb-2 tracking-widest">Bundle Name</label>
                   <input 
                    type="text" 
                    value={name}
                    onChange={(e) => setName(e.target.value)}
                    placeholder="e.g., Morning IMAGING Standard"
                    className="w-full border-2 border-gray-50 rounded-xl p-5 text-xl font-bold focus:border-blue-500 bg-gray-50 outline-none transition-all"
                   />
                </div>
                <div>
                   <label className="block text-base font-bold text-gray-400 uppercase mb-2 tracking-widest">Target Department</label>
             ...
             <div className="space-y-4">
                <div className="flex items-center justify-between">
                   <h3 className="text-lg font-black text-gray-400 uppercase tracking-widest">Select Forms for this Bundle</h3>
                   <span className="text-base font-black text-[#00468B]">{selectedFormIds.length} Selected</span>
                </div>
                     ...
                     return (
                       ...
                       >
                         <div className="flex flex-col min-w-0 pr-4">
                           <span className="text-base font-bold truncate">{f.title}</span>
                         </div>
                         <div className={`w-7 h-7 rounded-full flex items-center justify-center border-2 ${isSelected ? 'bg-[#00468B] border-[#00468B] text-white' : 'border-gray-100'}`}>
